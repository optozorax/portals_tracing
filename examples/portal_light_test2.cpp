...
int main() {
	...
	if (isDrawHints) {
		p11.pos.y += 4;
		p12.pos.y -= 4;
		scene.array.push_back(new pt::Polygon(contour, p11, new Scatter(portalFirstColor0*Color(0.5, 0.5, 0.5))));
		scene.array.push_back(new pt::Polygon(contour, p12, new Scatter(portalSecondColor0*Color(0.5, 0.5, 0.5))));
	}
